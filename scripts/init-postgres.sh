...
export HINDEMITH_DB_URL="${HINDEMITH_DB_URL:-jdbc:postgresql://localhost:5432/$DB_NAME}"
export HINDEMITH_DB_USER="${HINDEMITH_DB_USER:-$DB_USER}"
export HINDEMITH_DB_PASSWORD="${HINDEMITH_DB_PASSWORD:-$DB_PASSWORD}"
