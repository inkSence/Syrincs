...
public class ValidatePatternsUseCase {
    ...
    public void validate(Pattern pattern, RhythmSpec spec, List<VoiceSpec> voices) {
        try{
            ...
            // Required voices: kick and snare
            ...
            // Pattern must contain exactly one line per voice
